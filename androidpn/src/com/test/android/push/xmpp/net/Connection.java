...
import com.test.android.push.xmpp.ssl.SSLConfig;
import com.test.android.push.xmpp.ssl.SSLKeyManagerFactory;
import com.test.android.push.xmpp.ssl.SSLTrustManagerFactory;
...
public class Connection {
    ...
    public void systemShutdown() {
    	log.debug("systemShutdown() start...");
    ...
    public void registerCloseListener(ConnectionCloseListener listener) {
    	log.debug("registerCloseListener() start...");
    ...
    public void unregisterCloseListener(ConnectionCloseListener listener) {
    	log.debug("unregisterCloseListener() start...");
    ...
    private void notifyCloseListeners() {
    	log.debug("notifyCloseListeners() start...");
        if (closeListener != null) {
            try {
    ...
    public void deliverRawText(String text) {
    	log.debug("deliverRawText() start...");
    ...
    public String getHostAddress() throws UnknownHostException {
    	log.debug("getHostAddress() start...");
    ...
    public int getMinorXMPPVersion() {
    	log.debug("getMinorXMPPVersion() end...");
        return minorVersion;
    }
