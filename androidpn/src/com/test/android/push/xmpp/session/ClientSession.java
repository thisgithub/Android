...
import com.test.android.push.xmpp.auth.AuthToken;
...
public class ClientSession extends Session {
    ...
    public String getAvailableStreamFeatures() {
    	 log.debug("getAvailableStreamFeatures() start...");
        ...
        log.debug("getAvailableStreamFeatures() end...");
        return sb.toString();
    }
