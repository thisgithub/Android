...
public class ServiceLocator {
    ...
    public static String USER_SERVICE = "androidService";
     ...
     */
    public static AndroidService getUserService() {
        return (AndroidService) XmppServer.getInstance().getBean(USER_SERVICE);
    }
