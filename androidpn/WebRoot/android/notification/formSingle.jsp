...
<form action="${basePath}/manage/sendSingle.action" method="post" style="margin: 0px;">
<input type="hidden" name="id" value="${id }" />
<table width="600" cellpadding="4" cellspacing="0" border="0">
<tr id="trUsername">
	<td>用户名:</td>
	<td><input type="text" id="username" name="username" value="${username}" style="width:380px;" /></td>
</tr>
<tr>
	<td>标题:</td>
